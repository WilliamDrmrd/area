...
@Injectable()
export class Snow extends ActionAbstract implements ActionInterface {
  constructor(prisma: PrismaService) {
    super(prisma, 'Snow', 'When weather is snowy');
  }
  ...
  async execute(
    ...
    if (nine?.snow || fifteen?.snow) {
      ...
      return {
        ...
        runReaction: true,
        data: {
          message: `tomorrow gonna be snowy`,
          object: 'tomorrow gonna be snowy',
        },
      };
    }
