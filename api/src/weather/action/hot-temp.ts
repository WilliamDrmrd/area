...
export class HotTemp extends ActionAbstract implements ActionInterface {
  ...
  async execute(
    ...
    if (nine?.main.temp >= 25 || fifteen?.main.temp >= 25) {
      ...
      return {
        ...
        runReaction: true,
        data: {
          message: `tomorrow gonna be hot, temp: ${nine?.main.temp}C° at 9h and ${fifteen?.main.temp}C° at 15h`,
          object: 'tomorrow gonna be hot',
        },
      };
    }
